...
function App() {
  return (
    ...
    <Navbar /> 
    <div className="m-10 h-screen flex flex-wrap-reverse justify-around align-middle">
      ...
      <img className="my-auto w-3/4 md:w-1/2 h-auto rounded-xl drop-shadow-xl" src={Flag} /> 
    </div> 
      {/* <p className="mx-auto my-3 text-2xl font-bold">Colonial New York</p> */}
      <div className="mx-10 mb-32 flex flex-wrap justify-around align-middle">
        <img className="mx-auto mb-1 w-auto h-full drop-shadow-xl" src={MapImage} /> 
        <div className="w-full md:w-5/12 flex flex-col justify-around align-middle">
